    ...
    try {
      ...
      if (response.data.data.role === 'STUDENT') {
        Swal.fire({
          icon: 'error',
          title: 'Error',
          text: 'Permission denied for student',
          timer: 1500,
          ...
          <div className="hidden w-full xl:block xl:w-1/2">
            <div className="py-17.5 px-26 text-center">
              <h1 className="flex justify-center items-center gap-2">
                <span>
                  <img
                    className="bg-blue-700 p-3 box-content rounded-lg"
                    width={37}
                    src={levelearn}
                    alt=""
                  />
                ...
                <div className="text-black text-6xl font-bold">
                  Leve<span className="text-blue-700">l</span>earn
                </div>
              </h1>
              <div className="mt-3 text-lg font-bold">Level Up Your Learn</div>
          ...
          <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              <span className="mb-1.5 block font-medium">
                Log in to Manage Our Levelearn Application
              </span>
            ...
            <form onSubmit =  {handleSubmit}>
              ...
              <div className="mb-5">
                <button
                  type="submit"
                  disabled={loading}
                  className="text w-full cursor-pointer rounded-lg border font-medium border-primary bg-primary p-4 text-white transition hover:bg-opacity-90 disabled:opacity-50 disabled:cursor-not-allowed"
                >
