...
import { FaUser, FaBookOpen, FaMedal, FaExchangeAlt, FaUserCircle } from 'react-icons/fa';
    ...
    >
      ...
      <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
        <NavLink to="/" className="flex items-center">
          ...
          <div className="px-3 text-3xl text-white font-bold">LEVELEARN</div>
        </NavLink>
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <li>
                ...
                >
                  <FaBookOpen className="fill-current" size={18} />
                  Course
                </NavLink>
              </li>
              {/* <!-- Menu Item Course --> */}
              ...
              <li>
                ...
                >
                  <FaMedal className="fill-current" size={18} />
                  Badge
                </NavLink>
              </li>
              <li>
                ...
                >
                  <FaExchangeAlt className="fill-current" size={18} />
                  Trade
                </NavLink>
              </li>
              {/* <!-- Menu Item Chapter --> */}
              ...
              <li>
                ...
                >
                  <FaUserCircle className="fill-current" size={18} />
                  Profile
                </NavLink>
              </li>
              {/* <!-- Menu Item Profile --> */}
              ...
              {/* <li>
                <NavLink
                  to="/assessment"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname.includes('assessment') && 'bg-graydark dark:bg-meta-4'
                  }`}
                >
                  <svg
                    className="fill-current"
